...
class Customers extends Persons
{
	...
	*/
	public function get_row($row_id)
	{
		...
		$stats_due = $this->Customer->get_stats_accountan($person->person_id);
		if(empty($stats_due))
		{
			//create object with empty properties.
			$stats_due = new stdClass;
			$stats_due->due_amount = 0;
	/*cr*/	$stats_due->total_credits = 0;	/*/cr*/
	/*cr*/	$stats_due->rest_credits = 0;	/*/cr*/
			$stats_due->abonos = 0;
		}

		$data_row = $this->xss_clean(get_customer_data_row($person, $stats, $stats_due));
	...
	*/
	public function search()
	{
		...
		/*cr*/	$stats_due->rest_credits = 0;	/*/cr*/
			...
			$data_rows[] = $this->xss_clean(get_customer_data_row($person, $stats, $stats_due));
		}
	...
	*/
	public function save($customer_id = -1)
	{
		...
		$person_data = array(
			...
			'last_name' => $last_name,
			'cedula' => $this->input->post('cedula'), // Nukerj 14-01-2023
