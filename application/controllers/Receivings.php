...
class Receivings extends Secure_Controller
{
	...
	public function edit_item($item_id)
	{
		...
		$porcentaje = parse_decimals($this->input->post('porcentaje'));
		$cost = parse_decimals($this->input->post('cost'));
		...
		{
			$this->receiving_lib->edit_item($item_id, $description, $serialnumber, $quantity, $discount, $porcentaje, $discount_type, $price, $cost, $receiving_quantity);
		}
		else
		{
