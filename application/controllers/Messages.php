...
class Messages extends Secure_Controller
{
	...
	{	
		...
		$batch_save_data = array(			
			'tasa' =>  empty($this->input->post('tasa')) ? $this->config->item('tasa') : $this->input->post('tasa'), // Nukerj 14-01-2023 Tasa de cambio
		);
		...
		echo json_encode(array(
			'success' => $success,
			'message' => "Tasa de Cambio Guardada Con Exito En Bs.: ".$this->input->post('tasa')
		));
