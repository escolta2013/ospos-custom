...
class Login extends CI_Controller
{
	...
	public function login_check($username)
	{
		...
		// Obtener el location_id del empleado y guardarlo en la sesión
    	$employee_info = $this->Employee->get_info_by_username($username);  
    	$this->session->set_userdata('location_id', $employee_info->location_id); // <-- Línea añadida
