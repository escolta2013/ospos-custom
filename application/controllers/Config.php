...
class Config extends Secure_Controller
{
	...
	private function _licenses()
	{
		...
		$license[$i]['title'] = 'Morsas Pro Shop  ' . $this->config->item('application_version');
	...
	public function save_locale()
	{
		...
		$batch_save_data = array(
			...
			'tasa' =>  empty($this->input->post('tasa')) ? 0 : $this->input->post('tasa'), // Nukerj 14-01-2023 Tasa de cambio
			...
			'tasa_ref' =>  empty($this->input->post('tasa_ref')) ? 1 : $this->input->post('tasa_ref'),
			'auto_cambio_tasa' =>  empty($this->input->post('auto_cambio_tasa')) ? 0 :1, // Nukerj 14-01-2023 Tasa de cambio automatica
			'number_locale' => $this->input->post('number_locale'),
