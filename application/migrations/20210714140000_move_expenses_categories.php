...
class Migration_move_expenses_categories extends CI_Migration {
    ...
    {
        error_log('Reverting expense categories module migration');
        $this->db->simple_query("UPDATE ospos_grants SET menu_group = 'general' WHERE permission_id = 'expenses_categories'");
        error_log('Reverting expense categories module migration completed');
    }
}