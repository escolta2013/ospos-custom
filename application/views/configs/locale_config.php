	...
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				...
				<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_tipo_ref'), 'tipo_ref', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-8'>
					<label class="radio-inline">
						<?php echo form_radio(array(
							'name' => 'tasa_ref',
							'value' => '1',
							'checked' => $this->config->item('tasa_ref') == '1')); ?>
						<?php echo $this->lang->line('config_tasa_bcv'); ?>
					</label>
					<label class="radio-inline">
						<?php echo form_radio(array(
							'name' => 'tasa_ref',
							'value' => '2',
							'checked' => $this->config->item('tasa_ref') == '2')); ?>
						<?php echo $this->lang->line('config_tasa_paralelo'); ?>
					</label>
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_auto_cambio_tasa'), 'auto_cambio_tasa', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-2'>
					<?php echo form_checkbox(array(
						'name' => 'auto_cambio_tasa',
						'id' => 'auto_cambio_tasa',
						'value' => 'auto_cambio_tasa',
						'checked'=>$this->config->item('auto_cambio_tasa'))); ?>
				</div>
			</div>
			...
			<!-- Nukerj 14-01-2023 Tasa de cambio -->
			<?php 
			...
			if($username=="admin" || $username=="mfnunez" || $username=="mreyes"){             
				?>
				<div class="form-group form-group-sm">
					<?php echo form_label($this->lang->line('config_tasa'), 'tasa', array('class' => 'control-label col-xs-2')); ?>
					<div class='col-xs-1'>
						<?php echo form_input(array(
							'name' => 'tasa',
							'id' => 'tasa',
			...
			<div class="form-group form-group-sm">
				...
				<div class='col-xs-4'>
					<?php echo form_dropdown('payment_options_order', array(
						'Morsas'=> 'Formas de pago Morsas', // Morsas custom payment types
