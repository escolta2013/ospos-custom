...
<div class="o_action_manager module">
  <div class="o_action o_view_controller">
      ...
      <div class="o_cp_top hidden-xs">
        <div class="o_cp_top_left">
          <ol role="navigation" class="breadcrumb">
            ...
            <li accesskey="b"><a href="<?php echo site_url('/statements');?>"><?php echo $this->lang->line('module_statements'); ?></a></li>
    ...
    <div id="page_title"><?php echo $this->lang->line('module_statements'); ?></div>
