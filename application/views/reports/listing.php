	...
	<div class="col-md-4">
		<div class="panel panel-primary">
			...
			<div class="list-group">
				...
				{
					if (preg_match('/reports_/', $grant['permission_id'])
						&& !preg_match('/(inventory|receivings)/', $grant['permission_id']))
					{
	...
	<div class="col-md-4">
		<div class="panel panel-primary">
			...
			<div class="list-group">
				...
				// Añadir "Cuentas por pagar" usando el helper estándar:
				//show_report('summary','reports_accounts_payable_by_category');
				echo '<script>console.log('. json_encode(array_column($grants,'permission_id')) .');</script>';
