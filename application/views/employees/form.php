	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="employee_login_info">
			<fieldset>
				...
				<div class="form-group form-group-sm">	
					<?php echo form_label('¿Es Administrador?', 'is_admin', array('class'=>'control-label col-xs-3')); ?>
					<div class="col-xs-4">
						<label class="radio-inline">
							<?php echo form_radio(array(
								...
								'id'=>'is_admin',
								'value'=>1,
								'checked'=>$person_info->is_admin === '1')
							); ?> <?php echo"Si"; ?>
						</label>
						<label class="radio-inline">
							<?php echo form_radio(array(
								...
								'id'=>'is_admin',
								'value'=>0,
								'checked'=>$person_info->is_admin === '0')
							); ?> <?php echo"No"; ?>
						</label>
                ...
                <div class="form-group form-group-sm">
  <?php echo form_label('Tienda para Inventario', 'inventory_location_id', array('class'=>'control-label col-xs-3')); ?>
  <div class='col-xs-8'>
    <?php 
      // $stock_locations debe venir del controlador Employees->view()
      echo form_dropdown(
        'inventory_location_id',
        $stock_locations,
        $person_info->inventory_location_id ?: 0,
        ['id'=>'inventory_location_id','class'=>'form-control']
      );
    ?>
  </div>
</div>
