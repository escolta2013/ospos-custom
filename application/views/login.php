...
<body  style="background-image:url(<?php echo base_url('uploads/fondopantalla.jpeg'); ?>);" class="bg-light d-flex flex-column">
  <main class="d-flex justify-content-around align-items-center flex-grow-1">
    <div style="background-color: rgba(255,255,255,0.6)"  class="container-login container-fluid d-flex flex-column flex-md-row  shadow rounded m-3 p-4 p-md-0">
  ...
  <footer class="d-flex justify-content-center flex-shrink-0 text-center">
    <div style="background-color: rgba(255,255,255,0.6)" class="footer container-fluid   rounded shadow p-3 mb-md-4 mx-md-3">
       <img width="50" height="50" src="<?php echo base_url('uploads/' . $this->Appconfig->get('company_logo')); ?>" alt="<?php echo $this->lang->line('common_logo') . '&nbsp;' . $this->config->item('company'); ?>">
      </span>
      <span><?php echo $this->config->item('system_name') ; ?></span>
    </div>
  </footer>
</body>
