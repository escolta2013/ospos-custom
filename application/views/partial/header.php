...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . $this->lang->line('common_powered_by') . ' Morsas Pro Shop ' . $this->config->item('application_version') ?></title>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>"><small><?php echo $this->config->item('company'); ?></small></a>
				</div>
					...
					<ul class="nav navbar-nav navbar-right">
						<?php foreach($allowed_modules as $module): ?> 
							...
							<li class="<?php echo $module->module_id == $this->uri->segment(1) ? 'active' : ''; ?>">
								<a href="<?php echo site_url("$module->module_id"); ?>" title="<?php echo "Tasa de Cambio"; ?>" class="menu-icon">
									<img src="<?php echo base_url() . 'images/menubar/exchangue.png'; ?>" border="0" alt="Module Icon"/><br/>
									<?php echo "Tasa de Cambio"; ?>
								</a>
							</li>
						<?php }else{
							?>
